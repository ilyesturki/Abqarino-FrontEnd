...
const ContactSection = () => (
  ...
  <div className="flex flex-col items-center">
    ...
    <h1 className="text-[clamp(2.2rem,4vw,3.2rem)] font-extrabold leading-[1.15] tracking-tight text-ink text-center">
    ...
    <a href="mailto:turki.ilyes.dev@gmail.com">
      ...
      <CustomButton title="Nous contacter" icon={faLocationArrow} />
